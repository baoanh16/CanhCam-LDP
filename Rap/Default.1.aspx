...
<head runat="server">
	...
	<meta name="description"
		content="⭐Công ty chuyên thiết kế website trọn gói theo yêu cầu với các dịch vụ chuyên nghiệp✅uy tín hàng đầu về sáng tạo nội dung tiếp thị, lập trình web">
	<meta property="og:title" content="Công Ty Thiết Kế Website Chuyên Nghiệp, Uy Tín Tại TP. HCM">
	<meta property="og:description"
		content="⭐Công ty chuyên thiết kế website trọn gói theo yêu cầu với các dịch vụ chuyên nghiệp✅uy tín hàng đầu về sáng tạo nội dung tiếp thị, lập trình web">
	<meta property="og:site_name" content="Cánh Cam">
	<meta itemprop="name" content="Công Ty Thiết Kế Website Chuyên Nghiệp, Uy Tín Tại TP. HCM">
	<meta itemprop="description"
		content="⭐Công ty chuyên thiết kế website trọn gói theo yêu cầu với các dịch vụ chuyên nghiệp✅uy tín hàng đầu về sáng tạo nội dung tiếp thị, lập trình web">
	<meta name="google-site-verification" content="tkT5hkq5JknCfnlYz-Ld_J3HMGxuMtfa7E7HdJR4LCE">
	<meta name="google-site-verification" content="OXVLKTkSoTOmBsvNqpTc7zqpTzdSlndKyisIs-WuMrM">
	<link rel="stylesheet"
		href="https://fonts.googleapis.com/css?family=Barlow:200,300,300i,400,400i,500,600,700&amp;amp;subset=vietnamese">
	<link rel="shortcut icon" href="https://www.canhcam.vn/thiet-ke-website-ban-hang/favicon.ico" type="image/x-icon">
